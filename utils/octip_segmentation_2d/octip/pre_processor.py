...
__author__ = 'Gwenole Quellec (gwenole.quellec@inserm.fr) Philippe Zhang (philippe.zhang@univ-brest.fr)'
__copyright__ = 'Copyright (C) 2024 LaTIM'
...
class PreProcessor(object):
    ...
    def __call__(self,
        ...
        preprocessed = self.process_image(cv2.imread(sample, cv2.IMREAD_GRAYSCALE), segmentations)
