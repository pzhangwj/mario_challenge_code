...
sudo docker run --rm --gpus all -v $(pwd):/app  -v /home/pzhang/Data/database/MARIO_CHALLENGE/data_1_update/val:/app/data -v $(pwd)/output:/app/output mario_inference python inference_pipeline_task_1.py
...
sudo docker run --rm --gpus all -v $(pwd):/app  -v /home/pzhang/Data/database/MARIO_CHALLENGE/data_2/data_task2/val:/app/data -v $(pwd)/output:/app/output mario_inference python inference_pipeline_task_2.py
